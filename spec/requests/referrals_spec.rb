...
RSpec.describe "/referrals", type: :request do
  ...
  # ReferralsController, or in your router and rack
  ...
  describe "GET /index" do
    it "renders a successful response" do
      ...
      get referrals_url, headers: valid_headers, as: :json
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Referral" do
        expect {
          post referrals_url,
               params: { referral: valid_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      it "does not create a new Referral" do
        expect {
          post referrals_url,
               params: { referral: invalid_attributes }, as: :json
        }.to change(Referral, :count).by(0)
      end

      it "renders a JSON response with errors for the new referral" do
        post referrals_url,
             params: { referral: invalid_attributes }, headers: valid_headers, as: :json
    ...
    context "with valid parameters" do
      ...
      it "updates the requested referral" do
        ...
        patch referral_url(referral),
              params: { referral: new_attributes }, headers: valid_headers, as: :json
        referral.reload
  ...
  describe "DELETE /destroy" do
    it "destroys the requested referral" do
      referral = Referral.create! valid_attributes
      expect {
        delete referral_url(referral), headers: valid_headers, as: :json
      }.to change(Referral, :count).by(-1)
    end
  end
end
